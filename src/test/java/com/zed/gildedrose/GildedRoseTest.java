...
public class GildedRoseTest {
    ...
    public void testUpdateQualityBackstage() {
        ...
        GildedRose gildedRose = new GildedRose(new Item[] {
                new Item(GildedRose.BACKSTAGE_PASSES_TO_CONCERT,7,0)});
    ...
    public void testUpdateQualityAgedBrie() {
        ...
        GildedRose gildedRose = new GildedRose(new Item[] {
                new Item(GildedRose.AGED_BRIE,6,0)});
    ...
    public void testUpdateQualitySulfuras() {
        ...
        GildedRose gildedRose = new GildedRose(new Item[] {
                new Item(GildedRose.SULFURAS,5, GildedRose.SULFURAS_QUALITY)});
    ...
    public void testUpdateQualitySulfurasWrongQuality() {
        ...
        GildedRose gildedRose = new GildedRose(new Item[] {
                new Item(GildedRose.SULFURAS,0,0)});
    ...
    public void testUpdateQualityConjured() {
        ...
        GildedRose gildedRose = new GildedRose(new Item[] {
                new Item(GildedRose.CONJURED,2,4)});
        ...
        gildedRose = new GildedRose(new Item[] {
                new Item(GildedRose.CONJURED,2,11)});
    ...
    @Test
    public void testUpdateQualityCycle() {
        ...
        Assert.assertEquals(1, gildedRose.getItems()[0].sellIn);
        Assert.assertEquals(6, gildedRose.getItems()[0].quality);
        Assert.assertEquals(1, gildedRose.getItems()[1].sellIn);
        Assert.assertEquals(2, gildedRose.getItems()[1].quality);

        gildedRose.updateQuality();
        Assert.assertEquals(0, gildedRose.getItems()[0].sellIn);
        Assert.assertEquals(5, gildedRose.getItems()[0].quality);
        Assert.assertEquals(0, gildedRose.getItems()[1].sellIn);
        Assert.assertEquals(0, gildedRose.getItems()[1].quality);
